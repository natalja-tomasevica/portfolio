...
def ds_and_ml_projects(request):
    return render(request, 'ds_and_ml_projects/ds_and_ml_projects.html', {})

def predicting_stars_galaxies_quasars_project(request):
    return render(request, 'ds_and_ml_projects/predicting_stars_galaxies_quasars_project.html', {})

def user_churn_project(request):
    return render(request, 'ds_and_ml_projects/user_churn_project.html', {})
