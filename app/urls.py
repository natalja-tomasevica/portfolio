...
urlpatterns = [
    ...
    path('ds_and_ml_projects', views.ds_and_ml_projects, name = 'ds_and_ml_projects'),
    
    path('ds_and_ml_projects/predicting_stars_galaxies_quasars_project', views.predicting_stars_galaxies_quasars_project, name = 'predicting_stars_galaxies_quasars_project'),
    path('ds_and_ml_projects/user_churn_project', views.user_churn_project, name = 'user_churn_project'),
